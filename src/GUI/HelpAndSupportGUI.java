...
public class HelpAndSupportGUI extends JPanel {
    ...
    HelpAndSupportGUI(){
        ...
        JLabel header = new JLabel("<html><u>Need Some help</u></html>");
        JTextArea faq = new JTextArea("\n\n1. How to find good companies as there are many publicly listed companies in the Indian stock market?\n\n" +
                ...
                "Let’s look at a national currency like the rupee. It can be deposited in your name at a vsct, or privately stuffed into a mattress at home far away from anyone’s eyes.\n" +
