...
import Data.NewsAndArticlesStock;
...
public class NewsAndArticlesGUI extends JPanel {
    ...
    NewsAndArticlesGUI() {
        ...
        NewsAndArticlesStock news = new NewsAndArticlesStock();
        ...
        JLabel heading1 = new JLabel(h1, SwingConstants.CENTER);

        heading1.setPreferredSize(new Dimension(1200, 100));
        JTextArea article1 = new JTextArea(a1, 1, 1);
        article1.setEditable(false);
        article1.setLineWrap(true);
        article1.setMargin(new Insets(10, 10, 10, 10));

        JLabel heading2 = new JLabel(h2, SwingConstants.CENTER);
        JTextArea article2 = new JTextArea(a2, 1, 1);
