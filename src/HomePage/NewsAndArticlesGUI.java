...
public class NewsAndArticlesGUI extends JPanel {
    ...
    NewsAndArticlesGUI(){
        ...
        JTextArea article1 = new JTextArea("A cryptocurrency (or “crypto”) is a digital currency that can be used to buy goods and services", 1,1);
        ...
        JTextArea article2 = new JTextArea("A cryptocurrency (or “crypto”) is a digital currency that can be used to buy goods and services", 1,1);
        ...
        JTextArea article3 = new JTextArea("A cryptocurrency (or “crypto”) is a digital currency that can be used to buy goods and services", 1,1);
